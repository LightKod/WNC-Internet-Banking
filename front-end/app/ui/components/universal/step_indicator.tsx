...
export const StepIndicator = forwardRef<StepIndicatorRef, StepIndicatorProps>(function StepIndicator (props, ref) {
    ...
    const gridStyle = `grid ${gridColStyles[stepLength] || 'grid-cols-1'} gap-2 group md:gap-4`
        ...
        <div className={gridStyle}>
            {props.steps.map((step, index) => (
                <div key={index} className="flex flex-col">
                    ...
                    <div className="hidden flex-col pt-0 max-h-0 h-full opacity-0 gap-y-0.5 group-hover:pt-4 group-hover:max-h-full group-hover:opacity-100 transition-all duration-300 overflow-hidden md:flex">
