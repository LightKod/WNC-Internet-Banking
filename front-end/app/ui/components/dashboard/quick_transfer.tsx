...
export default function QuickTransfer() {
    const contacts: Contact[] = [
        {
            name: "Christmas Tree",
            accountNumber: "251220241234567",
            bankName: "Internal"
        },
        {
            name: "Happy New Year",
            accountNumber: "010120251234567",
            bankName: "The Other Bank"
        }
    ]
    ...
    return (
        <div className="flex flex-col gap-y-4 p-4 bg-white border-2 border-slate-100 rounded-md shadow-sm">
            ...
            <div className="grid grid-cols-7 md:grid-cols-5 xl:grid-cols-7 gap-2 mt-2">
                ...
                <Tooltip>
                    <TooltipTrigger>
                        <button className="w-full flex text-gray-500 items-center justify-center aspect-square rounded-full bg-slate-200 hover:bg-slate-300 transition-all duration-300">
